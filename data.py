...
fieldnames = (
    "state","year","obesity_percentage","alcohol_consumption","tobacco_percentage","per capita income"
)
...
with open('clean_datasets/merged_results.csv', 'r') as csvfile:
    with open('merged_results.json', 'w') as jsonfile:
